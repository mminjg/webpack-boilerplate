...
(function () {
  window.addEventListener("popstate", _router__WEBPACK_IMPORTED_MODULE_0__.router);
  document.addEventListener("DOMContentLoaded", _router__WEBPACK_IMPORTED_MODULE_0__.router);
})();
})();
